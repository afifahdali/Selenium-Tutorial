...
# example of using Expected Condition
...
#print attribute and value of the object
print(dir(driver))
...
'''
Create wait object that will pause the 
execution until an element is present on 
the webpage. 
'''
